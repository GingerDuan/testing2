...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        result = self.client.get("/")
        self.assertIn(b"Please RSVP", result.data) #still in homepage
        # party_result = self.client.get("/")
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        game_results = self.client.get("/games")
        self.assertIn(b"Games", game_results.data)
